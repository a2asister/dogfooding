    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <LayoutDashboard className="mx-auto h-12 w-12 text-white" />
          <h1 className="mt-4 text-3xl font-bold text-white">管理后台</h1>
          <p className="mt-2 text-gray-400">酒店订餐中心管理系统</p>
        </div>

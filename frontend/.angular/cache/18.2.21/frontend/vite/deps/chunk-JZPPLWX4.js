...
var printDocASTReducer = {
  ...
  ArgumentCoordinate: {
    leave: ({
      ...
      fieldName,
      argumentName
    }) => join([name, wrap2(".", fieldName), wrap2("(", argumentName, ":)")])
  },
  DirectiveCoordinate: {
    leave: ({
      name
...
var GraphQLDeprecatedDirective = new GraphQLDirective({
  ...
  locations: [DirectiveLocation.FIELD_DEFINITION, DirectiveLocation.ARGUMENT_DEFINITION, DirectiveLocation.INPUT_FIELD_DEFINITION, DirectiveLocation.ENUM_VALUE, DirectiveLocation.DIRECTIVE_DEFINITION],
  args: {
    reason: {
      type: GraphQLString,
...
var __Schema = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    directives: {
      ...
      resolve: (schema, {
        includeDeprecated
      }) => includeDeprecated ? schema.getDirectives() : schema.getDirectives().filter((directive) => directive.deprecationReason == null)
    }
  })
});
...
function getFragmentQueryDocument(document, fragmentName) {
  ...
  document.definitions.forEach(function(definition) {
    if (definition.kind === "OperationDefinition") {
      throw newInvariantError(112, definition.operation, definition.name ? " named '".concat(definition.name.value, "'") : "");
    }
...
function _getApolloClientMemoryInternals() {
  ...
  return {
    ...
    sizes: __assign({
      print: (_a3 = globalCaches.print) === null || _a3 === void 0 ? void 0 : _a3.call(globalCaches),
...
function linkInfo(link) {
  var _a3;
  return link ? __spreadArray(__spreadArray([(_a3 = link === null || link === void 0 ? void 0 : link.getMemoryInternals) === null || _a3 === void 0 ? void 0 : _a3.call(link)], linkInfo(link === null || link === void 0 ? void 0 : link.left), true), linkInfo(link === null || link === void 0 ? void 0 : link.right), true).filter(isDefined) : [];
}
      ...
      if (fields) {
        Object.keys(fields).forEach(function(fieldName) {
          ...
          if (!existing2 || (existing2 === null || existing2 === void 0 ? void 0 : existing2.typename) !== typename) {
            existing2 = existingFieldPolicies[fieldName] = {
              typename
            };
          }
    ...
    ObservableQuery2.prototype.refetch = function(variables) {
      ...
      if (globalThis.__DEV__ !== false && variables && hasOwnProperty8.call(variables, "variables")) {
        ...
        if (!vars || !vars.some(function(v) {
          ...
          globalThis.__DEV__ !== false && invariant2.warn(28, variables, ((_a3 = queryDef.name) === null || _a3 === void 0 ? void 0 : _a3.value) || queryDef);
        }
      }
    ...
    QueryManager2.prototype.maskOperation = function(options) {
      ...
      if (globalThis.__DEV__ !== false) {
        ...
        if (this.dataMasking && fetchPolicy === "no-cache" && !isFullyUnmaskedOperation(document) && !this.noCacheWarningsByQueryId.has(operationId)) {
          ...
          globalThis.__DEV__ !== false && invariant2.warn(45, (_c = getOperationName(document)) !== null && _c !== void 0 ? _c : "Unnamed ".concat(operationType !== null && operationType !== void 0 ? operationType : "operation"));
        }
      }
  ...
  function() {
    ...
    LocalState2.prototype.resolveDocument = function(document_1, rootValue_1) {
      return __awaiter(this, arguments, void 0, function(document, rootValue, context, variables, fragmentMatcher, onlyRunForcedResolvers) {
        var mainDefinition, fragments, fragmentMap, selectionsToResolve, definitionOperation, defaultOperationType, _a3, cache, client, execContext, isClientFieldDescendant;
        if (context === void 0) {
          context = {};
        }
        if (variables === void 0) {
  ...
  function() {
    function ApolloClient2(options) {
      ...
      this.devtoolsConfig = __assign(__assign({}, devtools), {
        enabled: (_a3 = devtools === null || devtools === void 0 ? void 0 : devtools.enabled) !== null && _a3 !== void 0 ? _a3 : connectToDevTools
      });
...
//# sourceMappingURL=chunk-JZPPLWX4.js.map
